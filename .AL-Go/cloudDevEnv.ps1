...
$GitHubHelperUrl = 'https://raw.githubusercontent.com/freddydk/AL-Go/checkSecrets/Actions/Github-Helper.psm1'
...
$ALGoHelperUrl = 'https://raw.githubusercontent.com/freddydk/AL-Go/checkSecrets/Actions/AL-Go-Helper.ps1'
